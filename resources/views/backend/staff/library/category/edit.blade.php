...
<div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            ...
            <li>{{ $category->name }} Redaktə Et</li>
        </ul>
    </div>
        ...
        <div class="card-body">
            <div class="heading-layout1">
                <div class="item-title">
                    <h3>{{ $category->name }} Redaktə Et</h3>
                </div>
            </div>
            <form class="new-added-form" method="POST" action="{{ route('staff.library.category.update',$category) }}">
                @csrf
                <div class="row">
